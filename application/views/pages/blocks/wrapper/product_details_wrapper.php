                                ...
                                <div class="col-lg-6">
                                    <div class="product-large-slider mb-20 slick-arrow-style_2">
                                        <div class="pro-large-img img-zoom" id="img1">
                                            <img src="<?= base_url(); ?>assets/img/product/product-details-img1.jpg" alt="" />
                                        </div>
                                        <div class="pro-large-img img-zoom" id="img2">
                                            <img src="<?= base_url(); ?>assets/img/product/product-details-img2.jpg" alt=""/>
                                        </div>
                                        <div class="pro-large-img img-zoom" id="img3">
                                            <img src="<?= base_url(); ?>assets/img/product/product-details-img3.jpg" alt=""/>
                                        </div>
                                        <div class="pro-large-img img-zoom" id="img4">
                                            <img src="<?= base_url(); ?>assets/img/product/product-details-img4.jpg" alt=""/>
                                        </div>
                                    </div>
                                    <div class="pro-nav slick-padding2 slick-arrow-style_2">
                                        <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img1.jpg" alt="" /></div>
                                        <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img2.jpg" alt="" /></div>
                                        <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img3.jpg" alt="" /></div>
                                        <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img4.jpg" alt="" /></div>
                                        <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img2.jpg" alt="" /></div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                            ...
                                            <div class="tab-pane fade show active" id="tab_one">
                                                <div class="tab-one">
                                                    ...
                                                    <div class="review-description">
                                                        <div class="tab-thumb">
                                                            <img src="<?= base_url(); ?>assets/img/about/services.jpg" alt="">
                                                        </div>
