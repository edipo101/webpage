                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <div class="brand-logo">
                                <a href="<?= base_url(); ?>">
                                    <img src="<?= base_url(); ?>assets/img/logo/<?= $header_data->logo ?>" alt="brand logo">
                                </a>
                            </div>
                        </div> <!-- end logo area -->
                        <div class="col-lg-9">
                                ...
                                <div class="header-middle-shipping mb-20">
                                    <div class="single-block-shipping">
                                        ...
                                        <div class="shipping-content">
                                            ...
                                            <span><?php echo $header_data->working_time ?></span>
                                        </div>
                                ...
                                <div class="header-middle-block">
                                    ...
                                    <!-- <div class="header-mini-cart">
                                        ...
                                        <div class="cart-total-price">
                                            <span>total</span>
                                            Bs <?= number_format($header_data->cart_total_price, 2) ?>
                                        </div>
                                        <ul class="cart-list">
                                            <li>
                                                <div class="cart-img">
                                                    <a href="product-details.html"><img src="<?= base_url(); ?>assets/img/cart/cart-1.jpg"
                                                            alt=""></a>
                                                </div>
                                                <div class="cart-info">
                                            ...
                                            <li>
                                                <div class="cart-img">
                                                    <a href="product-details.html"><img src="<?= base_url(); ?>assets/img/cart/cart-2.jpg"
                                                            alt=""></a>
                                                </div>
                                                <div class="cart-info">
                        ...
                        <div class="col-lg-12">
                            <div class="main-header-inner">
                                <div class="category-toggle-wrap">
                                    ...
                                    <nav class="category-menu <?= $categoryClass; ?>">
                                        <ul>
                                            <?php foreach ($header_data->category_rows as $key => $category): ?>

                                            <li class="menu-item-has-children"><a href="<?= base_url().'home/page/'.$category->go_page; ?>"><i class="fa fa-<?= $category->icon; ?>"></i>
                                                    <?= $category->category_name; ?></a>
                                                <?php 
                                                $sub_categories = $this->crud_mdl->fetch_by_field('sub_category', 'category', $category->category_id);
                                                if (count($sub_categories) > 0) :                                                
                                                ?>
                                                <ul class="category-mega-menu">
                                                    <li class="menu-item-has-children">
                                                        <a href="shop-grid-left-sidebar.html">Subcategorias</a>
                                                        <ul>
                                                            <?php foreach($sub_categories as $key => $subcateg): ?>
                                                            <li><a href="shop-grid-left-sidebar.html"><?= $subcateg->sub_category_name?></a></li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="shop-grid-left-sidebar.html"><i
                                                        class="fa fa-camera"></i> doramas</a>
                                                <!-- Mega Category Menu Start -->
                                                <ul class="category-mega-menu">
                                                    <li class="menu-item-has-children">
                                                        <a href="shop-grid-left-sidebar.html">Smarphone</a>
                                                        <ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="shop-grid-left-sidebar.html"><i
                                                        class="fa fa-book"></i> realitys show</a>
                                                <!-- Mega Category Menu Start -->
                                                <ul class="category-mega-menu">
                                                    <li class="menu-item-has-children">
                                            ...
                                            <li class="menu-item-has-children"><a href="shop-grid-left-sidebar.html"><i
                                                        class="fa fa-book"></i> articulos</a>
                                                <!-- Mega Category Menu Start -->
                                                <ul class="category-mega-menu">
                                                    <li class="menu-item-has-children">
                                                        <a href="shop-grid-left-sidebar.html">Smartphone</a>
