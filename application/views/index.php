...
<head>
	...
	<!-- helper class css -->
	<link href="<?= base_url(); ?>assets/css/helper.min.css" rel="stylesheet">
	<!-- Plugins CSS -->
	<link href="<?= base_url(); ?>assets/css/plugins.css" rel="stylesheet">
	<!-- Main Style CSS -->
	<link href="<?= base_url(); ?>assets/css/style.css" rel="stylesheet">
	<link href="<?= base_url(); ?>assets/css/skin-default.css" rel="stylesheet" id="galio-skin">
</head>
...
<body>
	...
	<div class="wrapper">
		<!-- header area start -->
		<?php $this->load->view('pages/blocks/header'); ?>

		<!-- page start -->		
		<?php $this->load->view('pages/'.$page.'.php'); ?>                        

		<!-- brand area start -->
		<?php $this->load->view('pages/blocks/brand.php'); ?>

		<!-- footer area start -->
		<?php $this->load->view('pages/blocks/footer.php') ?>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="product-large-slider slick-arrow-style_2 mb-20">
                                    ...
                                    <div class="pro-large-img">
                                        <img src="<?= base_url(); ?>assets/img/product/product-details-img5.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="pro-nav slick-padding2 slick-arrow-style_2">
                                    <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img1.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img2.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img3.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img4.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="<?= base_url(); ?>assets/img/product/product-details-img5.jpg"
                                            alt="" /></div>
                                </div>
                            </div>
                            <div class="col-lg-7">
